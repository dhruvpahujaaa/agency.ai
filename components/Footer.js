...
const Footer = ({ theme }) => {
  return (
    ...
    >
      ...
      <div className="flex justify-between lg:items-center max-lg:flex-col gap-10">
        ...
        >
          ...
          <div className="flex gap-2 text-sm">
            <input type="email" name="" id="" placeholder='Enter your email' className='w-full p-3 text-sm outline-none rounded dark:text-gray-200 bg-transparent border border-gray-300 dark:border-gray-500' />
      ...
      >
        <p>Copyright 2025 &copy; Akshat - All Right Reserved.</p>
