...
const TrustedBy = () => {
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className='flex flex-col items-center px-4 sm:px-12 lg:px-24 xl:px-40 gap-10 pt-16 sm:pt-24 lg:pt-32 pb-16 sm:pb-24 lg:pb-32 text-gray-700 dark:text-white/80'
    >
      <motion.h3
